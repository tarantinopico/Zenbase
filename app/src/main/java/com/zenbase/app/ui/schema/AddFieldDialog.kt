package com.zenbase.app.ui.schema
...
fun AddFieldDialog(
    ...
    var selectedType by remember { mutableStateOf<FieldType>(FieldType.TextType) }
    var defaultValue by remember { mutableStateOf("") }
    var isUnique by remember { mutableStateOf(false) }

    val fieldTypes = listOf(
        FieldType.TextType, FieldType.NumberType, FieldType.DateType, FieldType.CheckboxType,
        FieldType.ImageType, FieldType.UrlType, FieldType.RatingType, FieldType.BarcodeType, FieldType.LocationType
    )
